...
export default function Portfolio() {
  return (
    <div className="min-h-screen bg-white text-black py-12">
      ...
      <main className="max-w-full mx-auto px-4 pt-8"> {/* Reduced padding-top */}
        ...
        <section id="work" className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"> {/* Added grid layout for responsiveness */}
            <WorkCard
        ...
        <section id="projects" className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"> {/* Added grid layout for responsiveness */}
            ...
            <ProjectCard
              title="Minesweeper"
              description="A complete Minesweeper game where you uncover tiles and flag mines on a randomly generated grid."
              tools="Java" />
            <ProjectCard
              title="Anagame"
              description="An anagram game where users generate as many valid anagrams as possible within a time limit."
              tools="Python" />
            <ProjectCard
              title="Word Ladder"
              description="A word ladder game that uses BFS algorithms to validate and find the shortest path through word ladders."
              tools="Python, BFS" />
          </div>
        </section>
